...
class AccountHandler {
    ...
    static newTransaction(fromUUID, toUUID, fromPIN, amount) {
        return new Promise(async (resolve, reject) => {
            ...
            try {
                await sequelize.transaction(async (t) => {
                    ...
                    await User.update({ balance: sender.dataValues.balance - amount }, { where: { uuid: fromUUID } });
                    await User.update({ balance: reciever.dataValues.balance + amount }, { where: { uuid: toUUID } });
    ...
    static async authenticate(uuid, pin) {
        return new Promise((resolve, reject) => {
